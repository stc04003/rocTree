...
[![packageversion](https://img.shields.io/badge/Package%20version-0.99.9-orange.svg?style=flat-square)](commits/master)
...
Different from many existing tree building algorithms, the `rocTree` incorporate time-dependent covariates by constructing 
...
Moreover, the `rocTree` package also offers a novel risk prediction forest algorithm, where the ensemble is on unbiased
