...
* `Frame` is a data frame describe the resulting tree. The columns are 
  ...
  * `cutVal` indicate the covaraite value (after transformation) being split at the node.
  * `cutOrd` indicate the rank of the covaraite value being split at the node.
